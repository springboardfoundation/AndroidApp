...
import com.android.springboard.neednetwork.dummy.DummyContent.DummyItem;
...
public class NeedsFragmentAdapter extends RecyclerView.Adapter<NeedsFragmentAdapter.ViewHolder> {
    ...
    public NeedsFragmentAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
